...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column" >
            <form class="form-horizontal" action="${pageContext.request.contextPath}/transferMoney?ID=${user.ID}" method="post">
                ...
                <div class="form-group">
                    <label for="money" class="col-sm-2 control-label">目标卡号</label>
                    <div class="col-sm-10">
                        <label for="inputID">
                            <input type="text" class="form-control" id="inputID" name="inputID" placeholder="inputID"><br>
                        </label>
                    </div>
                </div>
                <div class="form-group">
